...
def __main__:
 account_name=input("follow4folloq02828383837")
   if account_name=="":
     print('please input a real name')
   else if req.on(`www.instagram.com/%follow4folloq02828383837%`)==Flase:
     print('I didnt found your instagram account')
 print("[1] - Followers")
 print("");print("[1] - Likes ");print("");print("[2] - Views ");print("");print("[1] - Followers ");print("");
   choose=input('> ')
       if choose=="1":
          url=input('https://www.instagram.com/follow4folloq02828383837/)
          if req.url==False:
